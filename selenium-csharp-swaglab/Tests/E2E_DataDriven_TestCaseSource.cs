...
public class E2E_DataDriven_TestCaseSource : Base
{
    ...
    {
        yield return new TestCaseData("standard_user", "secret_sauce", "lohi", "user", "test", "12456");
        yield return new TestCaseData("standard_user", "secret_sauce", "hilo", "user", "test", "34567");
    }
}
